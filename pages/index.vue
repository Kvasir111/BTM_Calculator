  ...
  <div class="h-screen flex bg-black">
    <div class="m-auto bg-white rounded p-2 w-full sm:w-1/3" id="mainDiv">
      <form id="programEntry">
        ...
        <div class="" key=index v-for="(lift, index) in maxes">
          <div class="mx-auto text-center w-full">
            <input
              class="text-center w-1/2 sm:w-1/3 border-b-2 border-black outline-none p-2"
              v-bind:id="lift.lift"
              v-bind:placeholder="lift.lift"
              v-model="lift.weight">
            x
            <input
              class="inline text-center w-1/2 sm:w-1/3 border-b-2 border-black outline-none p-2"
              placeholder="Reps"
        ...
        <div class="mx-auto text-center p-2">
          <button class="bg-red-600 py-2 px-2 rounded text-center italic font-bold" id="calculateButton" type="button"
                  v-on:click="calculateProgram">Calculate Program
          </button>
        </div>
      </form>
    </div>
